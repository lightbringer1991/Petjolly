...
<!--				<p class="calendar_date"></p>		-->
		...
		<div class="row">
			<div class="panel panel-default" data-appointment="day">
				<div class="panel-heading">
					<h3 class="panel-title">Today<span class="badge pull-right">42</span></h3>
				</div>
					<ul class="list-group">
						<li class="list-group-item">
							...
							Appointment number - Customer name
			...
			<div class="panel panel-default" data-appointment="next_day">
				<div class="panel-heading">
					<h3 class="panel-title">Tomorrow<span class="badge pull-right">2</span></h3>
				</div>
					<ul class="list-group">
						<li class="list-group-item">
							<a tabindex="0" data-toggle="popover" data-content="Customer name, customer phone">
								<h3 class="list-group-item-heading">
									<div class="square" style="background: red;"></div>
									16:00:00 - 20 minutes
								</h3>
