...
<div id="inline1" <?PHP /* ?> style="width:500px;" <?php */ ?>>
		...
		<div class="step1 steps" id="step1">
			<form action="#" method="POST" name="step1-form" id="step1-form">
				<div class="row">
...
<BR />
			...
			<div class="row buttons"><a href="javascrip::void(0)" class="button-next"  onclick="nextStep('step2','step3')"><img src="images/steps/next.jpg" /></a></div>
	...
	<div class="step3 steps"  id="step3" style="display:none">
		...
		<!--start Step2-->   
		  ...
		  <div class="row photos">
			...
			<div class="row buttons"><a href="javascrip::void(0)" class="button-next"  onclick="nextStep('step3','step4')"><img src="images/steps/next.jpg" /></a></div>
