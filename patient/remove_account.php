...
if($objLogin->IsLoggedInAsPatient()){
	...
	if($submit == 'remove'){
        ...
        }else if(!$objLogin->CheckAccountPassword('patient', $user_password)){
...
?>
	...
	<form action="index.php?member=remove_account" method="post" name="frmProfile">
		...
		<tr>
			<td colspan="2">
				...
				&nbsp;
				<a href="javascript:appGoTo('patient=my_account');"><?php echo _BUTTON_CANCEL; ?></a>
			</td>
		</tr>
		<tr><td colspan="3">&nbsp;</td></tr>
		</table>
