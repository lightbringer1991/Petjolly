...
if(!$objLogin->IsLoggedIn() && (ModulesSettings::Get('patients', 'allow_registration') == 'yes')){
	...
	draw_title_bar(prepare_breadcrumbs(array(_PATIENTS=>'', _CREATING_NEW_ACCOUNT=>'')));
...
<?php }else{ ?>
	...
	<div class="pages_contents">
		...
		<form action="index.php?patient=create_account" method="post" name="frmRegistration" id="frmRegistration">
			...
			<tr>
				...
				<td nowrap="nowrap"><input type="text" id="company" name="company" size="32" maxlength="255" value="<?php echo decode_text($company);?>" autocomplete="off" /></td>
			...
			<tr><td colspan="3" nowrap="nowrap" height="7px"></td></tr>
