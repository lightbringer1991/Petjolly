...
define("_ADMINS_AND_PATIENTS","Customers & Admins");
define("_ADMINS_DOCTORS_AND_PATIENTS","Admins, Doctors & Customers");
...
define("_ALREADY_HAVE_APPOINTMENT","You already have an appointment to doctor: _DOCTOR_ at _DATE_! <br>Please choose another date or <a href=index.php?member=my_appointments>cancel</a> a previous appointment to book another one.");
...
define("_APPOINTMENT_RESCHEDULED_BY_PROVIDER", "Appointment has been rescheduled");
...
define("_APPOINTMENT_ASSIGNED_TO_PATIENT_ALERT","Appointment has been assigned to a selected customer! Click <b>Book Now</b> button to proceed.");
define("_APPOINTMENT_ASSIGNED_TO_PATIENT_MSG","This appointment is assigned to customer: _PATIENT_.");
...
define("_APPOINTMENT_SIGNIN_ALERT","To complete this appointment you must be logged in as a customer");
define("_APPOINTMENT_GUEST_REGISTRATION_ALERT","To complete this appointment you must be register as a patient");
...
define("_APPT_CONFIRMED_ALREADY_MSG","Your appointment has already been confirmed! <br><br>Click <a href='index.php?member=my_appointments'>here</a> to continue.");
define("_APPT_CONFIRMED_SUCCESS_MSG","Thank you for confirming your appointment. We look forward to seeing you soon. <br>To see your current appointments please click <a href='index.php?member=my_appointments'>here</a>.");
...
define("_ASSIGN_PATIENT","Assign Customer");
define("_AT_TIME","at");
...
define("_BUSINESS_NAME_EMPTY_ALERT","Businese name cannot be empty! Please re-enter.");
define("_BUSINESS_SETUP","Business Setup");
...
define("_CANCELED_BY_PATIENT","Canceled by customer");
...
define("_CHANGE_PATIENT","Change Customer");
define("_CHANGE_YOUR_PASSWORD","Change your password");
define("_CHECKIN","Checkin");
...
define("_DOCTOR","Provider");
define("_DOCTORS","Providers");
...
define("_DOCTOR_MISSING_SPECIALITIES_ALERT","You still have not added specialities to your profile. We recommend to add at least one speciality to allow customers to see your profile in the search results. Click <a href='_HREF_'>here</a> to proceed.");
...
define("_PAID", "Paid");
define("_PROVIDER_SERVICES", "Provider Services");
define("_PROVIDER_PACKAGES", "Provider Packages");
...
define("_DOCTOR_UPGRADE_MEMBERSHIP_ALERT","Currently your profile is not available for search. To make it visible for your customers you have to upgrade your membership plan. Click here <a href=_HREF_>here</a> to proceed.");
define("_DOWN","Down");
...
define("_EMPTY","Empty");
define("_EMPTY_PATIENT_NAME_ALERT","The customer name is empty! Please enter a customer name for searching or click Set Admin button to assign administrator to this appointment.");
...
define("_FIND_DOCTORS","Find Provider");
...
define("_FOR_ME","Me");
define("_FOR_PATIENT","for customer");
...
define("_GUEST_REGISTRATION","Guest user Registration");
...
define("_PROVIDER_HDR_TEMPLATE","Provider Template");
define("_MEMBER_HDR_TEMPLATE","Member Template");
...
define("_HIDE","Hide");
define("_HOME","Home");
define("_HOME_PAGE_WELCOME_TEXT","<p>Welcome to Administrator Control Panel that allows you add, edit or delete site content. With this Administrator Control Panel you can easy manage customers and perform a full site management.</p>
...
define("_ITEMS","Items");
define("_I_EXISTING_PATIENT","I'm an existing customer of this practice");
define("_I_NEW_PATIENT","I'm a new customer");
...
define("_MAY","May");
define("_MD_APPOINTMENTS","This module provides an efficient way to maintain appointments. A customer can create and manage its own appointments, administrator may manage them via Admin Panel.");
...
define("_MD_PATIENTS","The Customers module allows easy customers management on your site. Administrator can create, edit or delete customer accounts. Customers could register on the site and log into their accounts.");
define("_MD_PAYMENTS","The module Payments allows you to easily accepts and manage payments for appointments from customers.");
...
define("_MD_REMINDER","The Appointments Reminder module is used to automate notification for customers");
...
define("_MSN_ADMIN_CHANGE_PATIENT_PASSWORD","Admin Changes Customer Password");
...
define("_MSN_ALLOW_PATIENTS_LOGIN","Allow Customers to Login");
define("_MSN_ALLOW_PATIENTS_REGISTRATION","Allow Customers to Register");
...
define("_MSN_PATIENT_ARRIVAL_REMINDER","Customer Arrival Reminder");
define("_MSN_PATIENT_CONFIRM_REMINDER","Customer Confirm Reminder");
...
define("_MS_ADMIN_CHANGE_PATIENT_PASSWORD","Specifies whether to allow changing customer password by Admin");
...
define("_MS_ALLOW_DOCTORS_SEARCH_LOCATION","Specifies whether to allow customers to search by doctors by location");
define("_MS_ALLOW_DOCTORS_SEARCH_NAME","Specifies whether to allow customers to search by doctors by name");
define("_MS_ALLOW_MULTIPLE_APPOINTMENTS","Specifies whether to allow multiple appointments to the doctor in the same day");
define("_MS_ALLOW_PATIENTS_LOGIN","Specifies whether to allow existing customers to login");
define("_MS_ALLOW_PATIENTS_REGISTRATION","Specifies whether to allow customers to register");
define("_MS_ALLOW_PATIENTS_RESET_PASSWORDS","Specifies whether to allow customers to restore their passwords");
...
define("_MS_MAXIMUM_ALLOWED_APPOINTMENTS","Specifies the maximum allowed appointments (not approved) per customer in a day");
...
define("_MS_PATIENTS_IMAGE_VERIFICATION","Specifies whether to allow image verification (captcha) on customer registration page");
define("_MS_PATIENT_ARRIVAL_REMINDER","Specifies a time interval in hours, before arrival  reminder will be sent to customer");
define("_MS_PATIENT_CONFIRM_REMINDER","Specifies a time interval in hours, before confirm reminder will be sent to customer");
...
define("_MS_SCHEDULES_ACCESS_LEVEL","Specifies customer access level to view doctor schedules");
...
define("_NO_PATIENTS_FOUND","No Customers Found");
define("_NO_PATIENTS_FOUND_ALERT","No customers found! Try another search or click Set Admin button to assign administrator to this appointment.");
...
define("_ONLY_PATIENTS_ACCESS","Only customers can access this page!");
define("_OPEN","Open");
define("_OPEN_ORDER_NOTICE","You have an order that has not yet paid! Please wait while your order is processed or <a href=index.php?provider=my_orders>cancel</a> any open orders if you want to proceed with a new booking.");
...
define("_REPASSWORD","Re-Password");
...
define("_PATIENT","Customer");
define("_PATIENTS","Customers");
define("_PATIENTS_AWAITING_MODERATION_ALERT","There are _COUNT_ customer/s awaiting approval of registration. Click <a href='index.php?admin=mod_customers_management'>here</a> for review.");
define("_PATIENTS_MANAGEMENT","Customers Management");
define("_PATIENTS_RATING","Customers Rating");
define("_PATIENTS_SETTINGS","Customers Settings");
define("_PATIENT_APPOINTMENT_ACCEPTED","Customer Appointment has been accepted and approved!");
define("_PATIENT_ARRIVAL_REMINDER_EMAIL","Customer Arrival Reminder Email");
define("_PATIENT_CONFIRMED_APPOINTMENT","Customer has confirmed appointment");
define("_PATIENT_CONFIRM_REMINDER_EMAIL","Customer Confirm Reminder Email");
define("_PATIENT_GROUP","Customer Group");
define("_PATIENT_GROUPS","Customer Groups");
define("_PATIENT_INFO","Customer Info");
define("_PATIENT_LOGIN","Customer Login");
define("_PATIENT_NOTES","Customer Notes");
define("_PATIENT_REQUESTED_APPOINTMENT","Customer has requested appointment");
...
define("_PD_PAYMENT_MODULES","Customers, Doctors & Payments");
...
define("_SELECT_PATIENT_ALERT","Select customer from drop down box and click Apply button to proceed.");
...
define("_VOTE_NOT_REGISTERED","Your vote has not been registered! You must be logged in as a customer before you can vote.");
...
/*
define("_WELCOME_DOCTOR_TEXT","<p>Hello <b>_FIRST_NAME_ _LAST_NAME_</b>!</p><p>Welcome to Doctor's Account Panel, that allows you to view account status, manage your account settings etc.</p><p>_TODAY_<br />_LAST_LOGIN_</p><p><b>&#8226;</b> To view this account summary just click on a <a href='index.php?provider=home'>Dashboard</a> link.</p><p><b>&#8226;</b> <a href='index.php?provider=my_account'>Edit My Account</a> page allows you to change your personal info and account data.</p>
<p><b>&#8226;</b> <a href='index.php?provider=my_specialities'>My Specialities</a> page allows you to manage your specialities.</p>
...
<p><b>&#8226;</b> To view this account summary just click on a <a href='index.php?member=home'>Dashboard</a> link.</p>
<p><b>&#8226;</b> <a href='index.php?member=my_account'>Edit My Account</a> page allows you to change your personal info and account data.</p>
<p><b>&#8226;</b> <a href='index.php?member=my_appointments'>My Appointments</a> page allows you to review and manage your appointments.</p>");
