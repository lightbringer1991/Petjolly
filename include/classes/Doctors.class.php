...
class Doctors extends MicroGrid {
	...
	{		
		...
		if($account_type == 'me'){
			$this->formActionURL = 'index.php?provider=my_account';
			$add_mode = false;
			...
			$this->formActionURL = 'index.php?provider=my_account';
//            $this->formActionURL = 'index.php?provider=provider_management';
			$add_mode = true;
		...
		$this->VIEW_MODE_SQL = 'SELECT '.$this->tableName.'.'.$this->primaryKey.',
								...
								FROM '.$this->tableName.'
                                    LEFT OUTER JOIN '.TABLE_DOCTOR_SPECIALITIES.' ON '.$this->tableName.'.id = '.TABLE_DOCTOR_SPECIALITIES.'.doctor_id ';
		...
		$this->EDIT_MODE_SQL = 'SELECT
								...
								IF('.$this->tableName.'.membership_expires = "0000-00-00", "<span class=gray>- never -</span>", DATE_FORMAT('.$this->tableName.'.membership_expires, \''.$this->sqlFieldDateFormat.'\')) as mod_membership_expires,
		...
		$this->arrEditModeFields = array(
			'separator_personal_info'   =>array(
				...
				'address_1'    => array('title'=>_ADDRESS, 'type'=>'textbox',  'width'=>'210px', 'required'=>true, 'readonly'=>false, 'maxlength'=>'70', 'default'=>'', 'validation_type'=>'', 'unique'=>false, 'visible'=>true),
				'address_2'    => array('title'=>_ADDRESS_2, 'type'=>'textbox',  'width'=>'210px', 'required'=>true, 'readonly'=>false, 'maxlength'=>'70', 'default'=>'', 'validation_type'=>'', 'unique'=>false, 'visible'=>true),
				'city'    => array('title'=>_CITY, 'type'=>'textbox',  'width'=>'210px', 'required'=>true, 'readonly'=>false, 'maxlength'=>'70', 'default'=>'', 'validation_type'=>'', 'unique'=>false, 'visible'=>true),
				'country'    => array('title'=>_COUNTRY, 'type'=>'textbox',  'width'=>'210px', 'required'=>true, 'readonly'=>false, 'maxlength'=>'70', 'default'=>'', 'validation_type'=>'', 'unique'=>false, 'visible'=>true),
...
/*
		    ...
		    'separator_contact_information'   =>array(
				...
				'email' 		=> array('title'=>_EMAIL_ADDRESS, 'type'=>'textbox', 'width'=>'230px', 'required'=>false, 'maxlength'=>'70', 'validation_type'=>'email', 'unique'=>true, 'autocomplete'=>'off'),        // check for post_html in this page if this field is enabled
			),
*/
/*
		    'separator_membership_info' =>array(
...
//		$this->arrEditModeFields['separator_contact_information']['email']['post_html'] = $reactivation_html;
	 ...
	 *		@param $limit_clause
	 */
	public static function GetAllActive($where_clause = '', $limit_clause = '', $order="ASC", $limit = '')
	{		
...
//                $inner_output .= '<div class="ratings_stars" id="rt_doctor_'.$doctor_id.'"></div>';
            ...
            if($info_type == 'short'){
                ...
                $output .= '</td><td>';
                if($markers_count) $output .= '<img src="http://maps.googleapis.com/maps/api/staticmap?size='.$map_width.'x'.$map_height.'&maptype=roadmap&sensor=false'.$markers.'" alt="Doctor Addresses">';
                $output .= '</td></tr></table>';
            }
	...
	public static function DrawDoctorMap($doctor_id, $info_type = 'long', $mode = '', $result = array(), $draw = true)
	{
		global $objLogin;
		$output = '';
...
//			$output .= _DOCTOR_PROFILE_INACTIVE;
	...
	public static function SetMembershipInfoForDoctor($doctor_id = 0, $membership_plan_id = 0, $operation = '')
	{
        if($operation == '+'){
            ...
            if(!empty($membership_plan)){
                $membership_plan['expires'] = (($membership_plan['duration'] > -1) ? date('Y-m-d', mktime(0, 0, 0, date('m'), date('d') + $membership_plan['duration'], date('Y'))) : '0000-00-00');
	...
	public static function UpdateMembershipInfo($params = array(), $where_clause = '')
	{
        ...
        $membership_expires = isset($params['expires']) ? $params['expires'] : '0000-00-00';
