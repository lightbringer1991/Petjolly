...
class Application {
	...
	public static function Init()
	{
		...
		self::$params['member']	 = isset($_GET['member']) ? prepare_input($_GET['member']) : '';
        
//		self::$params['doctor']	     = isset($_GET['doctor']) ? prepare_input($_GET['doctor']) : '';
        self::$params['provider']	 = isset($_GET['provider']) ? prepare_input($_GET['provider']) : '';
		...
		if(self::$PROJECT == 'MicroCMS'){
			...
			if($objLogin->IsLoggedInAsPatient()) if(self::$params['member'] == '' && self::$params['page'] == '') self::$params['member'] = 'home';
		...
		self::$params['provider_template'] = ($objSettings->GetProviderTemplate() != '') ? $objSettings->GetProviderTemplate() : DEFAULT_TEMPLATE;
		self::$params['member_template'] = ($objSettings->GetMemberTemplate() != '') ? $objSettings->GetMemberTemplate() : DEFAULT_TEMPLATE;
