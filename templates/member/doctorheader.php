	<div class="page-header-inner">
			<!-- BEGIN LOGO -->
			<div class="page-logo">
				<a href="index.php?doctor=home&lang=en">
				<img src="assets/frontend/layout/img/logos/logo1.png" alt="logo" class="logo-default"/>
				</a>
						...
						<li class="dropdown dropdown-user dropdown-dark">
							...
							<ul class="dropdown-menu dropdown-menu-default">
								...
								<li>
									...
									<i class="icon-rocket"></i> My Specialities <span class="badge badge-success">
									</a>
								</li>
