...
It's very easy to get started with ApPHP Medical Appointment!!!

1. Installation:
   http://apphp.com/php-medical-appointment/index.php?page=installation 
   or docs/Installation.htm

2. Getting Started:
   http://apphp.com/php-medical-appointment/index.php?page=getting-started
   or docs/Getting Started.htm


-----------------------------------------------------------------------------------
For more information visit: 
	site 	http://apphp.com/php-medical-appointment/index.php?page=examples
