...
if(!$objLogin->IsLoggedInAsDoctor()){
    ...
    redirect_to('index.php?provider=login');
	...
	$address_1    = isset($_POST['last_name']) ? prepare_input($_POST['address_1']) : '';
	$address_2    = isset($_POST['last_name']) ? prepare_input($_POST['address_2']) : '';
	
	$city    = isset($_POST['city']) ? prepare_input($_POST['city']) : '';
	$country    = isset($_POST['last_name']) ? prepare_input($_POST['country']) : '';
	...
	$query='update meda_doctors set 
				...
				b_address=\''.encode_text($address_1).'\',
				b_address_2=\''.encode_text($address_2).'\',
				b_city=\''.encode_text($city).'\',
				b_country=\''.encode_text($country).'\',
