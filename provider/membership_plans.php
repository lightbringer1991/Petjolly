...
<ul class="nav nav-tabs">
    <li class="active"><a data-toggle="tab" href="#membership_plans">Membership Plan</a></li>
    <li><a data-toggle="tab" href="#membership_orders">My Orders</a></li>
</ul>

<div class="tab-content">
    <div id="membership_plans" class="tab-pane fade in active">
<?php
...
?>
    ...
    <div id="membership_orders" class="tab-pane fade">
<?php
...
$(".plans_wrapper div.item").on('click', function() {
    $(document).find('div.item').removeClass('active');
