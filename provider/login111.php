...
<!--	<div class="pages_contents">-->
	...
	<form class="login-form" action="index.php?provider=login" method="post">
    <?php draw_hidden_field('submit_login', 'login'); ?>
		...
		<div class="form-actions">
			...
			if(ModulesSettings::Get('doctors', 'allow_reset_passwords') == 'yes'){
						...
						echo '<a href="index.php?provider=password_forgotten" id="forget-password" class="forget-password">Forgot Password?</a>';
		...
		<div class="create-account">
			<p>
				<a href="index.php?provider=create_account" id="register-btn" class="uppercase">Create an account</a>
			</p>
		</div>
	</form>
