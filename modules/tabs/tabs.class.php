 ...
 class Tabs
 {
	...
	*/
    public function Display($mode="")
    {
       ...
       //picking up id parameter that denotes which tab is selected
       ...
       echo "\n<!-- END This script is generated by tabs.class.php v.".Tabs::tabsVersion."(http://www.apphp.com/php-tabs/index.php) END -->\n";
